...
class HiderViewController: UIViewController, CBPeripheralManagerDelegate, CLLocationManagerDelegate {
    ...
    func blinkHideButton() {
        UIView.animate(withDuration: 0.5,
                                   ...
                                   animations: { self.hideButton.alpha = 0.0 },
                                   completion: nil)
    }
    ...
    func removeBlinkingHideAnimation() {
    ...
    func presentHiderLost() {
        ...
        // Blink Lost status label button
        self.statusLabel.text = "The Seeker found you!".localized
